 ...
 * @group Types
 * @category Utils
 * @param T type of decoder's value result
 */
 ...
 * @group Types
 * @category Decoders
 * @param T type of this decoder's result
 */
export abstract class Decoder<T> implements DecoderConfig<T> {
     ...
     * ```
     *
     * @param other decoder for next type U
...
/**
 * Unwraps a Decoder<T> to T
 *
 * @group Types
 * @category Utils
 * @param T type of Decoder's result
 */
